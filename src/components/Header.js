  ...
  return (
    <header className="pt-3 d-flex justify-content-sm-center">
      ...
      <div className="position-absolute top-0 end-0 pe-3 pt-2">
        <button type="button" data-bs-toggle="modal" data-bs-target="#info-modal" className="btn btn-anim btn-anim-sx border-0 p-1 fs-1"><BsInfoCircle /></button>
        <button type="button" data-bs-toggle="modal" data-bs-target="#stats-modal" className="btn btn-anim btn-anim-sy border-0 p-1 fs-1"><BsBarChart /></button>
        <button type="button" data-bs-toggle="modal" data-bs-target="#settings-modal" className="btn btn-anim btn-anim-rot border-0 p-1 fs-1"><BsGear /></button>
      </div>
    </header>
  )
}